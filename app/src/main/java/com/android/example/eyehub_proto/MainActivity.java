    ...
    private BottomNavigationView.OnNavigationItemSelectedListener mOnNavigationItemSelectedListener
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            ...
            if (itemId == R.id.navigationMyProfile) {
                return true;
            } else if (itemId == R.id.navigationMyCourses) {
                return true;
            } else if (itemId == R.id.navigationHome) {
                return true;
            } else if (itemId == R.id.navigationSearch) {
                return true;
            } else if (itemId == R.id.navigationMenu) {
...
//
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        else if (id == R.id.Turkish_language){
            LanguageManager.setLocale(this, "tr");
            recreate();
        }
